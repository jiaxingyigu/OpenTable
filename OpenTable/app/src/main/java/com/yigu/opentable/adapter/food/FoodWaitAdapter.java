package com.yigu.opentable.adapter.food;
...
/**
 * Created by brain on 2017/2/21.
 */
public class FoodWaitAdapter extends RecyclerView.Adapter<FoodWaitAdapter.ViewHolder>{
    ...
    public FoodWaitAdapter(Context context, List<MapiHistoryResult> list) {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        return new ViewHolder(inflater.inflate(R.layout.item_food_wait, parent, false));
    }
    ...
    public void onBindViewHolder(ViewHolder holder, int position) {
        ...
        holder.date.setText(itemResult.getUsedate());
//        holder.price.setText("总价：¥"+itemResult.getPrice());
        holder.name.setText(itemResult.getShopname());
        holder.tel.setText("电话："+ (TextUtils.isEmpty(itemResult.getTel())?"暂无":itemResult.getTel()));
