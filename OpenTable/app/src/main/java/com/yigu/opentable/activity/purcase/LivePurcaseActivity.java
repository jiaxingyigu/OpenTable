    ...
    private void initListener() {
        ...
        payWayLayout.setPayWayListener(new PayWayTwoLayout.PayWayListener() {
            ...
            public void preorder() {
                ...
                showLoading();
                OrderApi.preorder(LivePurcaseActivity.this,companyId, userSP.getUserBean().getUSER_ID(), SHOP, allPrice+"", sales,payWayLayout.getBz(),"",eid,
                    ...
                    public void success(Object success) {
                        ...
                        try {
                            ...
                            startActivity(new Intent(LivePurcaseActivity.this, OrderCompleteActivity.class).putExtra("back","cook"));
                        } catch (DbException e) {
                            e.printStackTrace();
                        }
                    }
            ...
            public void balancepay() {
                ...
                showLoading();
                OrderApi.balancepay(LivePurcaseActivity.this, companyId,userSP.getUserBean().getUSER_ID(), SHOP, allPrice+"", sales, payWayLayout.getBz(),"",eid,
                        payWayLayout.getCtype1(),payWayLayout.getCtype2(),payWayLayout.getCtype3(),payWayLayout.getSendPay(),new RequestCallback() {
                    @Override
                    public void success(Object success) {
                        hideLoading();
            ...
            public void weixinpay() {
                ...
                OrderApi.weixinPay(LivePurcaseActivity.this,companyId, userSP.getUserBean().getUSER_ID(), SHOP, allPrice + "", price +"",sales, payWayLayout.getBz(), "",eid,
...
//                            String orderInfo  = success.getJSONObject("data").getString("orderInfo");
            ...
            public void zhifubaopay() {
                ...
                showLoading();
                OrderApi.zhifubaoPay(LivePurcaseActivity.this,companyId, userSP.getUserBean().getUSER_ID(), SHOP,  allPrice +"", sales, payWayLayout.getBz(),"",eid,
                        payWayLayout.getCtype1(),payWayLayout.getCtype2(),payWayLayout.getCtype3(),payWayLayout.getSendPay(),new RequestCallback<JSONObject>() {//
                    @Override
                    public void success(JSONObject success) {//
                        hideLoading();
    ...
    private void callPay(final String orderInfo){
       ...
       /* final String payInfo = orderInfo + "&sign=\"" + sign ;*/
        ...
        Runnable payRunnable = new Runnable() {
            ...
            public void run() {
                // 构造PayTask 对象
                PayTask alipay = new PayTask(LivePurcaseActivity.this);
                // 调用支付接口，获取支付结果
                ...
                case SDK_PAY_FLAG: {
                    ...
                    if (TextUtils.equals(resultStatus, "9000")) {
                       /* showLoading();
                        ...
                        try {
                            Toast.makeText(LivePurcaseActivity.this, "支付成功", Toast.LENGTH_SHORT).show();
                            db.delete(MapiOrderResult.class);
                            startActivity(new Intent(LivePurcaseActivity.this,OrderCompleteActivity.class).putExtra("back","cook"));
                        } catch (DbException e) {
                            e.printStackTrace();
...
//					Toast.makeText(PayActivity.this, "支付成功", Toast.LENGTH_SHORT).show();
                        ...
                        if (TextUtils.equals(resultStatus, "8000")) {
                            Toast.makeText(LivePurcaseActivity.this, "支付结果确认中", Toast.LENGTH_SHORT).show();
                            ...
                            Toast.makeText(LivePurcaseActivity.this, "支付失败", Toast.LENGTH_SHORT).show();
