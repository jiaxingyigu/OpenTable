package com.yigu.opentable.adapter.tenant;
 ...
 */
public class TenantListAdapter extends RecyclerView.Adapter<TenantListAdapter.ViewHolder> {
    ...
    public TenantListAdapter(Context context, List<MapiOrderResult> list) {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        return new ViewHolder(inflater.inflate(R.layout.item_tenant_list, parent, false));
    }
