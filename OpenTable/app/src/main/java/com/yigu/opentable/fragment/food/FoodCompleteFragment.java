 ...
 */
public class FoodCompleteFragment extends BaseFrag {
    ...
    public void load() {
        showLoading();
        OrderApi.getSeatlist(getActivity(), userSP.getUserBean().getUSER_ID(), "1", pageIndex + "", pageSize + "", new RequestPageCallback<List<MapiHistoryResult>>() {
            @Override
