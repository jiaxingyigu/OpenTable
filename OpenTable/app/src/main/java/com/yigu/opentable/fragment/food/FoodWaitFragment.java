 ...
 */
public class FoodWaitFragment extends BaseFrag {
    ...
    public void load() {
        showLoading();
        OrderApi.getSeatlist(getActivity(), userSP.getUserBean().getUSER_ID(), "0", pageIndex + "", pageSize + "", new RequestPageCallback<List<MapiHistoryResult>>() {
            @Override
