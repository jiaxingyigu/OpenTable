...
public class HomeUnitLayout extends RelativeLayout {
    ...
    public HomeUnitLayout(Context context, AttributeSet attrs) {
        super(context, attrs);
        mContext = context;
        activity = (BaseActivity) mContext;
        initView();
    ...
    public HomeUnitLayout(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    private void initView() {
        if (isInEditMode())
            return;
        view = LayoutInflater.from(mContext).inflate(R.layout.layout_home_unit, this);
        ...
        mAdapter = new HomeUnitAdapter(activity, mList);
        recyclerView.setAdapter(mAdapter);
    }

    public void load(List<MapiCampaignResult> list) {
