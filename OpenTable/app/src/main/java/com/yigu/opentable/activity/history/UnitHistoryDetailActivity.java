    ...
    private void callPay(final String orderInfo) {
       ...
       /* final String payInfo = orderInfo + "&sign=\"" + sign ;*/
        ...
        Runnable payRunnable = new Runnable() {
            ...
            public void run() {
                // 构造PayTask 对象
                PayTask alipay = new PayTask(UnitHistoryDetailActivity.this);
                // 调用支付接口，获取支付结果
                ...
                case SDK_PAY_FLAG: {
                    ...
                    if (TextUtils.equals(resultStatus, "9000")) {
                       /* showLoading();
                        ...
                        Toast.makeText(UnitHistoryDetailActivity.this, "支付成功", Toast.LENGTH_SHORT).show();
                        DebugLog.i("支付宝支付成功");
                        setResult(RESULT_OK);
                        finish();
...
//					Toast.makeText(PayActivity.this, "支付成功", Toast.LENGTH_SHORT).show();
                        ...
                        if (TextUtils.equals(resultStatus, "8000")) {
                            Toast.makeText(UnitHistoryDetailActivity.this, "支付结果确认中", Toast.LENGTH_SHORT).show();

                        } else if (TextUtils.equals(resultStatus, "6002 ")) {
                            Log.i("info", "网络连接出错");
                        } else {
                            // 其他值就可以判断为支付失败，包括用户主动取消支付，或者系统返回的错误
                            Toast.makeText(UnitHistoryDetailActivity.this, "支付失败", Toast.LENGTH_SHORT).show();
        ...
        public void onReceive(Context context, Intent intent) {
            if (mark == 0) {
                if (ReceiverAction.WEIXIN_PAY_ACTION.equals(intent.getAction())) {
                    ...
                    Toast.makeText(UnitHistoryDetailActivity.this, "支付成功", Toast.LENGTH_SHORT).show();
                    DebugLog.i("微信支付成功");
                    UnitHistoryDetailActivity.this.setResult(RESULT_OK);
                    finish();
                }
            }
