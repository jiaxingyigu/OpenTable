...
public class FoodHistoryDetailActivity extends BaseActivity {
    @Bind(R.id.back)
    ImageView back;
    @Bind(R.id.center)
    TextView center;
    ...
    private void callPay(final String orderInfo){
       ...
       /* final String payInfo = orderInfo + "&sign=\"" + sign ;*/
        ...
        Runnable payRunnable = new Runnable() {
            ...
            public void run() {
                // 构造PayTask 对象
                PayTask alipay = new PayTask(FoodHistoryDetailActivity.this);
                // 调用支付接口，获取支付结果
                ...
                case SDK_PAY_FLAG: {
                    ...
                    if (TextUtils.equals(resultStatus, "9000")) {
                       /* showLoading();
                        ...
                        Toast.makeText(FoodHistoryDetailActivity.this, "支付成功", Toast.LENGTH_SHORT).show();
                        DebugLog.i("支付宝支付成功");
                        setResult(RESULT_OK);
                        finish();
...
//					Toast.makeText(PayActivity.this, "支付成功", Toast.LENGTH_SHORT).show();
                        ...
                        if (TextUtils.equals(resultStatus, "8000")) {
                            Toast.makeText(FoodHistoryDetailActivity.this, "支付结果确认中", Toast.LENGTH_SHORT).show();
                            ...
                            Toast.makeText(FoodHistoryDetailActivity.this, "支付失败", Toast.LENGTH_SHORT).show();
...
//                    Toast.makeText(TenantHistoryDetailActivity.this, "支付成功", Toast.LENGTH_SHORT).show();
                    DebugLog.i("微信支付成功");
                    FoodHistoryDetailActivity.this.setResult(RESULT_OK);
                    finish();
                }
            }
