    ...
    private void initListener() {
        ...
        payWayLayout.setPayWayListener(new PayWayTwoLayout.PayWayListener() {
            ...
            public void preorder() {
                ...
                showLoading();
                OrderApi.preordercanteen(PaymentActivity.this,companyId, userSP.getUserBean().getUSER_ID(), SHOP, allPrice+"", sales,payWayLayout.getBz(),"","",
            ...
            public void balancepay() {
                ...
                showLoading();
                OrderApi.balancepaycanteen(PaymentActivity.this,companyId, userSP.getUserBean().getUSER_ID(), SHOP, allPrice+"", sales,payWayLayout.getBz(),"", "",
                        payWayLayout.getCtype1(),payWayLayout.getCtype2(),payWayLayout.getCtype3(),payWayLayout.getSendPay(),new RequestCallback() {
                    @Override
                    public void success(Object success) {
                        hideLoading();
            ...
            public void weixinpay() {
                ...
                OrderApi.weixinPaycanteen(PaymentActivity.this,companyId, userSP.getUserBean().getUSER_ID(), SHOP, allPrice + "", price +"",sales, payWayLayout.getBz(),"","",
...
//                            String orderInfo  = success.getJSONObject("data").getString("orderInfo");
            ...
            public void zhifubaopay() {
                ...
                DebugLog.i(sales);
                showLoading();
                OrderApi.zhifubaoPaycanteen(PaymentActivity.this,companyId, userSP.getUserBean().getUSER_ID(), SHOP,  allPrice +"", sales, payWayLayout.getBz(),"","",
                        payWayLayout.getCtype1(),payWayLayout.getCtype2(),payWayLayout.getCtype3(),payWayLayout.getSendPay(),new RequestCallback<JSONObject>() {//
                    @Override
                    public void success(JSONObject success) {//
                        hideLoading();
