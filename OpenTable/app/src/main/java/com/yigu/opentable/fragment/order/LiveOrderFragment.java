 ...
 */
public class LiveOrderFragment extends BaseFrag {
...
//        pvTime.setRange(calendar.get(Calendar.YEAR), calendar.get(Calendar.YEAR) + 10);//要在setTime 之前才有效果哦
    ...
    public void load() {
        showLoading();
        OrderApi.getSaleslist(getActivity(), userSP.getUserBean().getUSER_ID(), "3", created,isfinish,state, pageIndex + "", pageSize + "",
